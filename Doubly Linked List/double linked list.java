 ...
 //---------------------------------------------------------------------------
    ...
    //-------------------------------------------------------------------------
        ...
        public void add (int index, Object element){ 
            ...
            if(index < 0 || index > this.lenth){ 
                ...
                myNode before = cur;
                myNode after = cur.next;
                
                input.prev = before;
                input.next = after; 
                before.next = after.prev = input;
            } 
    ...
    //-------------------------------------------------------------------------
        ...
        public void remove (int index){ 
           ...
           myNode cur = this.head;
           myNode del = this.head; 

            if(index == 0){ 
                this.head = this.head.next ; 
                this.head.prev = null;
            } 
            else if(index == this.lenth - 1){ 
    ...
    //-------------------------------------------------------------------------
        ...
        public ILinkedList sublist(int start , int end){
           ...
           if(start<0 || end >= this.lenth || start >= this.lenth || start > end || end <= 0){ 
                System.out.println("Error"); 
                return null; 
           }
